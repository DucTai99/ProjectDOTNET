...
namespace BookStore.Areas.Admin.Controllers
{
    ...
    public class AdminHomeController : Controller
    {
        ...
        [ValidateInput(false)]
        [HttpPost]
        public ActionResult Index(BookEditModel model)
        {
            if (ModelState.IsValid)
            {

                ViewBag.listBook = new BooksDao().updateBook(model.maSach, model.hinhAnh, model.moTa, model.tenSach, model.tenTacGia, model.soLuong, model.ngayXuatBan, model.khuyenMai, model.gia);
            }
